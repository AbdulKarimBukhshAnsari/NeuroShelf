  ...
  return (
    <SafeAreaView className="bg-backgroundLight h-full py-16 px-5">
      <View className="flex flex-row items-center gap-6 justify-center mb-10">
        <LogoComponent />
        <Text className="font-pbold text-primary text-3xl tracking-widest">KitabiBuddy</Text>
      </View>
      
      <View className="mt-6">
        <Text className="font-pbold text-2xl text-textPrimary mb-2">Sign In</Text>
        <Text className="font-pregular text-textSecondary mb-8">Welcome back! Please sign in to continue</Text>
        ...
        <View className="flex-row justify-center mt-8">
          <Text className="font-pregular text-textSecondary">Don't have an account? </Text>
